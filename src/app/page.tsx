  ...
  return (
    <div className="flex flex-col min-h-screen pb-20">
      ...
      <div className="grid grid-cols-2 gap-4 p-5 mt-2">
        <Link href="/rides" className="bg-neutral-900 p-5 rounded-2xl border border-neutral-800 flex flex-col items-center justify-center gap-3 active:scale-95 transition-transform">
        ...
        {activeVendors.length === 0 ? (
          ...
          <div className="flex flex-col gap-3">
            {activeVendors.map((vendor) => (
              <Link key={vendor.id} href={`/vendor/${vendor.id}`} className="bg-neutral-900 border border-neutral-800 p-4 rounded-2xl flex items-center justify-between active:scale-95 transition-transform">
                <div>
